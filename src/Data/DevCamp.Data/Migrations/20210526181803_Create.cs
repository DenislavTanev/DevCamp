        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Requiremnets = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoostedDeliveryPeriod = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BoostedDeliveryPrice = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageCheckItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackageCheckItems_Packages_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageTextItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackageTextItems_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageCheckItems_IsDeleted",
                table: "PackageCheckItems",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_PackageCheckItems_PackageId",
                table: "PackageCheckItems",
                column: "PackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageTextItems_IsDeleted",
                table: "PackageTextItems",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_PackageTextItems_PackageId",
                table: "PackageTextItems",
                column: "PackageId");
